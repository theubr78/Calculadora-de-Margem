    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 border border-gray-600 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="flex items-center space-x-3 p-4 rounded-lg bg-gray-700 hover:bg-gray-600 transition-colors text-left">
            ...
            <div>
              <p className="text-white font-medium">Buscar Produto</p>
              <p className="text-gray-400 text-sm">Consultar produto no OMIE</p>
            </div>
          </button>
